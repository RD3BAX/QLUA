...
local VT = (Fsettings.VType or "Close")
	vTRIX_MA1[I-P+1] = TRIX_MA1(I, {Period=P, Metod = M, VType=VT, round=R}, ds)
	if I >= P then
		vTRIX_MA2[I-P*2+2] = TRIX_MA2(I-P+1, {Period=P, Metod = M, VType="Any", round=R}, vTRIX_MA1)
		if I >= P*2-1 then
			vTRIX_MA3[I-P*3+3] = TRIX_MA3(I-P*2+2, {Period=P, Metod = M, VType="Any", round=R}, vTRIX_MA2)
			if I >= P*3-1 then
				Out=(vTRIX_MA3[I-P*3+3] - vTRIX_MA3[I-P*3+3-1]) / vTRIX_MA3[I-P*3+3-1] * 100
			end
		end
	end
