...
local Lo = Envelopes_MA(I, {Period=P, Metod = M, VType=VT, round=R}, ds)
if I>=P then 
	local Lup = Lo*(1+k/100)
	local Ldown = Lo*(1-k/100)
	return rounding(Lo, R), rounding(Lup, R), rounding(Ldown, R)
else
	return nil,nil,nil
end
end
