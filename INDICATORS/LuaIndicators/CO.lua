...
local R = (Fsettings.round or "off")
	...
	CumAD[I] = CO_AD(I, {SHORT_Period=SP, LONG_Period=LP, Metod=M, round=R}, ds)
	local rS_MA = S_MA(I, {Period=SP, Metod=M, VType="Any", round=R}, CumAD)
	local rL_MA = L_MA(I, {Period=LP, Metod=M, VType="Any", round=R}, CumAD)
	if I>=LP and rS_MA and rL_MA then
		Out = rS_MA-rL_MA
